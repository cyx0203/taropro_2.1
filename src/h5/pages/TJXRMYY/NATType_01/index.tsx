...
export default function main() {
  ...
  const GPage = usePage({
    ...
    pageName: "h5_pages_TJXRMYY_NATType_01_index",
    //用于接收外部发送的更新数据的事件
    ndaExcute: (nda: any) => {
  ...
  return (
    <Root hashData={styles}>
      <View className={styles.NATType_01}>
        {userCard ? (
          <Comp_UserInforCard
            config={userCard}
            type="01"
            ...
            return (
              ...
              >
                <View className={styles.cardInfo}>
                  ...
                  <View className={styles.card_img}>
                    <View className={styles.day}>{item.extra.day}</View>
                    <View>{item.extra.year}-{item.extra.mouth}</View>
                  </View>
