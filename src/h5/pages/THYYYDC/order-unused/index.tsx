...
export default function main() {
  ...
  const [currentTypeIndex, setCurrentIndex] = useState(0);
  ...
  const getTotal = () => {
    ...
    for (let i = 0; i < currentSelectComCList.length; i++) {
      total +=
        ...
        Number(getText(currentSelectComCList[i].price));
      total += currentSelectComCList[i].number * getText(packData?.money);
    }
  ...
  const getTotalNumber = () => {
    let total = 0;
    for (let i = 0; i < currentSelectComCList.length; i++) {
      total += currentSelectComCList[i].number;
    }
    return total;
  };
  /**
   ...
   */
  const changeComNumber = (type: String, item: any, index: number) => {
    ...
    return (
      <View className={styles.CommodityCard}>
        ...
        <View className={styles.infoTextArea}>
          ...
          <View className={styles.materialsInfo}>{infoObj.materialsInfo}</View>
          <View className={styles.sale}>已售： {infoObj.sale}</View>

          <View
            className={styles.price}
            dangerouslySetInnerHTML={{ __html: infoObj.price }}
          ></View>
        </View>
        <View className={styles.numberBtnArea}>
          <View className={styles.numberBtnLeft}>
            <Image
              src="http://material.pro220.ggzzrj.com/web/mini/THYYYDC/assets/icon/subtract.svg"
          ...
          <Image
            ref={plusBtn}
            src="http://material.pro220.ggzzrj.com/web/mini/THYYYDC/assets/icon/plus.svg"
      ...
      <View className={styles.SettlementBtn}>
        ...
        >
          <AtBadge value={getTotalNumber()} maxValue={99}>
            <Image
              src="http://material.pro220.ggzzrj.com/web/mini/THYYYDC/assets/icon/order.svg"
        ...
        <View
          ...
          onClick={() => {
            if (currentSelectComCList?.length)
              GPage.DoWXCall("settlementClick", currentSelectComCList,getTotal());
          }}
        >
          去结算
        </View>
   ...
   */
  const modalChangeNumber = (type: string, index: number) => {
    let selectData = [...currentSelectComCList];
    let showData = [...currentComCList];
    let allData = [...commodityList];
    if (type === "+") {
  ...
  return (
    <Root hashData={styles}>
      <View className={styles.order}>
        ...
        {/* 时间段 */}
        <View className={styles.timeQuantumArea} style={{'display':dateIsShow?'':'none'}}>
          <AtIcon
            value="chevron-right"
            size="30"
            color="#bbb"
        ...
        >
          <View className={styles.floatHeader}>
            ...
            >
              <Image
                src="http://material.pro220.ggzzrj.com/web/mini/THYYYDC/assets/icon/clear.svg"
          ...
          >
            <Image
              src="http://material.pro220.ggzzrj.com/web/mini/THYYYDC/assets/icon/pack.svg"
            ...
            <View className={styles.txt}>
              ...
              <View
                ...
                dangerouslySetInnerHTML={{ __html: packData.money }}
              ></View>
            </View>
            ...
            <View className={styles.modalContent}>
              ...
              <View className={styles.price}>
                <Image
                  ...
                  src="http://material.pro220.ggzzrj.com/web/mini/THYYYDC/assets/icon/money_1.svg"
                />
                {getText(currentComItem?.price)}
              </View>
            </View>
          </AtModalContent>
        </AtModal>
