...
export const main = class {
  static data() {
    ...
    return {
      type: "flex",
      config: {
        mod: "h5/pages/TJXRMYY/paymentList/index",
        title: "缴费列表",
        wxcall: {
          // 时间选择器
            ...
            UpateCurrentPageData({
              detailsArea: {
                ...
                floatData: {
                  ...
                  body: [
                    // label名如res可自定义
                    { testItem: "123", res: "1.00", unit: "001" },
                    { testItem: "123", res: "1.00", unit: "002" },
                    { testItem: "123", res: "1.00", unit: "003" },
                    { testItem: "123", res: "1.00", unit: "004" }
                  ]
                }
              }
            });
