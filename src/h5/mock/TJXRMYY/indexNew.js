...
export const main = class {
  static data() {
    ...
    return {
      type: "flex",
      config: {
        mod: "h5/pages/TJXRMYY/indexNew/index",
        title: "新首页",
        wxcall: {
          // [底部导航] 按钮
        ...
        data: {
          ...
          // 轮播图列表
          bannerUrlList: [
            { title: "01", img: `${RES}/assets/ad/banner04.png` },
            // { title: "02", img: `${RES}/assets/img/banner04.png` },
            // { title: "03", img: `${RES}/assets/img/banner04.png` }
          ],
          // 轮播图上自定义文字内容（可传标签）
          bannerText:`核酸地点：XXXXXX<br/>这是第二行文字：XXXX`,
          //   标签区域
          menuTabData: {
            //标签数据
            tabs: [
            ...
            menuList: [
              [
                {
                  title: "智能导诊",
                  icon: `${RES}/assets/icon/tab-menu-16.png`
                },
                {
                  title: "住院预交",
                  icon: `${RES}/assets/icon/tab-menu-17.png`
                },
                {
                  title: "医院导航",
                  icon: `${RES}/assets/icon/tab-menu-18.png`
                },
                {
                  title: "住院费用",
                  icon: `${RES}/assets/icon/tab-menu-19.png`
                },
                {
                  title: "住院费用",
                  icon: `${RES}/assets/icon/tab-menu-20.png`
                },
                {
                  title: "住院充值记录",
                  icon: `${RES}/assets/icon/tab-menu-21.png`
                }
              ],
              [
                {
                  title: "当日挂号",
                  icon: `${RES}/assets/icon/tab-menu-03.png`
                },
                {
                  title: "当日挂号",
                  icon: `${RES}/assets/icon/tab-menu-04.png`
                },
                {
                  title: "当日挂号",
                  icon: `${RES}/assets/icon/tab-menu-05.png`
                }
              ],
              [
                {
